...
class TournamentManager:
    ...
    def run_round_robin(self, agents: List[PlayerAgent], rounds_per_match: int = 10) -> Dict[str, Any]:
        ...
        self.logger.log_tournament_start(agent_names, "round_robin", total_matches)
    ...
    def _play_match(self, agent1: PlayerAgent, agent2: PlayerAgent, num_rounds: int) -> Dict[str, Any]:
        ...
        for round_num in range(1, num_rounds + 1):
            ...
            # Update histories
            agent1_history.append(result["move1"])
            agent2_history.append(result["move2"])
    ...
    def _play_single_round(self, agent1: PlayerAgent, agent2: PlayerAgent, round_num: int,
        ...
        Args:
            ...
            agent1_history: Agent1's move history
            agent2_history: Agent2's move history
        ...
        try:
            ...
            print(f"⚠️ Error getting moves: {e}")
